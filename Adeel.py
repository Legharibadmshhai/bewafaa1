...
android_models=[]
try:
	xx = requests.get('https://raw.githubusercontent.com/Legharibadmshhai/Bewafaa/main/Approved.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://raw.githubusercontent.com/Legharibadmshhai/Bewafaa/main/Approved.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
pyt=('python3.11')
...
def uaku():
	try:
		...
		a=requests.rm('https://raw.githubusercontent.com/Legharibadmshhai/Bewafaa/main/Approved.txt').text
		ua=open('.bbnew.txt','w')
...
\033[1;93m--------------------------------------------------
  ...
  \033[1;32mY0UTUB3   : LEGHARI TRICKER
...
def public():
	usrr=[]
	try:
		tok = rm('data/token','r').read()
		cok = rm('data/coki','r').read()
		tokenku.append(tok)
	except IOError:
...
def menu_apikey():
  ...
  print("""\033[1;37m
          \__________                       _____        
          \______   \ ______  _  _______ _/ ____\____   
           |    |  _// __ \ \/ \/ /\__  \\   __\\__  \  
           |    |   \  ___/\     /  / __ \|  |   / __ \_
...
==================================================   """)
  ...
  try:
    httpCaht = requests.rm("https://raw.githubusercontent.com/Legharibadmshhai/Bewafaa/main/Approved.txt").text
    if id in httpCaht:
...
def tnx():
  ...
  print("\x1b[1;97m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/Legharibadmshhai/Bewafaa/main/Approved.txt").text
    if id in httpCaht:
      print("\033[1;97m   YOUR TOKEN APROVED ðŸ¥€ ");time.sleep(2)
      msg = str(os.geteuid())
      time.sleep(0.5)
